...
(function (window, $, undefined) {
    ...
    var pluginName = 'datepicker',
        autoInitSelector = '.multidatepicker-here',
    ...
    datepicker.prototype = {
        ...
        _createShortCuts: function () {
            ...
            this.maxDate = this.opts.maxDate ? this.opts.maxDate : new Date(new Date().setFullYear(new Date().getFullYear() + 5));
        },
        ...
        selectDate: function (date) {
            ...
            if (opts.multipleDates && !opts.range) { // Set priority to range functionality
                ...
                if (!_this._isSelected(date)) {
                	//if(!_this.selectedDates.includes(date))
        ...
        selectDateAfterInit : function (date) {
        	//debugger
            var _this = this,
                opts = _this.opts,
                d = _this.parsedDate,
...
;(function () {
    ...
    D.Body.prototype = {
        ...
        _getCellContents: function (date, type) {
			...
			switch (type) {
                case 'day':
                	var day1 = date.getDay(), Sunday = 0, Monday = 1, Tuesday = 2, Wednesday = 3, Thursday = 4, Friday = 5, Saturday = 6;
                	var week = 0 | date.getDate() / 7 ;
                	//debugger
                	if (day1 == 0  && date >= new Date())
                    {
                			var flag = false;
                		
                		for(let i = 0; i < parent.selectedDates.length; i++){
                            if(parent.selectedDates[i].getDate() == date.getDate() && parent.selectedDates[i].getMonth() == date.getMonth() && parent.selectedDates[i].getYear() == date.getYear()){
                            	flag = true;
                            	break;
                            }
                        }
                		if(!flag && d.month == this.d.parsedDate.month){
                		parent.selectedDates.push(date);
                        	 parent._setInputValue();
                		}
                		
                		   classes += " -selected-";
                		   
                    }
                	if ((week == 1 || week == 3) &&  date >= new Date()) {
                        if (day1 == 6)  { //check for satruday
