...
////currencies
//var cur = new Array();
//cur[0]='Afghani'; // Afghanistan
//cur[1]='Lek'; // Albania
//cur[2]='Dinar'; // Algeria
//cur[3]='' ; // American Samoa
//cur[4]='New Kwanza'; // Angola
//cur[5] = ''; // Anguilla
//cur[6] = ''; // Antartica
//cur[7]='East Caribbean dollar'; //Antigua and Barbuda
//cur[8]='Peso';  // Argentina
//cur[9]='Dram'; // Armenia
//cur[10]=''; // Aruba
//cur[11]=''; //"Ashmore and Cartier Island
//cur[12]='Australian dollar'; // Australia
//cur[13]='Euro'; // Austria
//cur[14]='Manat'; // Azerbaijan
//
//cur[15]='Bahamian dollar'; // Bahamas
//cur[16]='Bahrain dinar'; // Bahrain
//cur[17]='Taka'; // Barbados
//cur[18]='Barbados dollar';
//cur[19]='Belorussian ruble'; // Belarus
//cur[20]='Euro'; // Belgium
//cur[21]='Belize dollar'; // Belize
//cur[22]='CFA Franc'; // Benin
//cur[23]=''; // Bermuda
//cur[24]='Ngultrum'; // Bhutan
//cur[25]='Boliviano'; // Bolivia
//cur[26]='Marka'; // osnia and Herzegovina
//cur[27]='Pula'; // Botswana
//cur[28]='Real'; // Brazil
//cur[29]='';// British Virgin Islands
//cur[30]='Brunei dollar'; // Brunei
//cur[31]='Lev'; // Bulgaria
//cur[32]='CFA Franc'; // Burkina Faso
//cur[33]=''; //Burma
//cur[34]='Burundi franc'; //Burundi
//
...
//"Cook Islands", "Costa Rica", "Cote dIvoire", "Croatia", "Cuba", "Cyprus", "Czeck Republic", 
...
//con[31]='Cayman Islands';cur[31]=''; //Cayman Islands
...
//con[33]='Chad';cur[33]=''; // Christmas Island
//con[34]='Chile';cur[34]=''; // Clipperton Island
//con[35]='China';cur[35]=''; // Cocos (Keeling) Islands
//
//con[36]='Colombia';cur[36]='Colombian Peso'; // Colombia
//con[37]='Comoros';cur[37]='Franc'; // Comoros
//con[38]='Congo(DRC)';cur[38]=''; // Congo, Republic of the
//con[39]='Congo(ROC)';cur[39]=''; // Cook Islands
//con[40]='Costa Rica';cur[40]='Colón'; // Costa Rica
//con[41]='Cóte dIvoire';cur[41]='CFA Franc'; //Cóte dIvoire
//
//con[42]='Croatia';cur[42]='Kuna'; // Croatia
//con[43]='Cuba';cur[43]='Cuban Peso'; // Cuba
//con[44]='Cyprus';cur[44]='Cyprus pound';// Cyprus
//con[45]='Czeck Republic';cur[45]='Koruna'; // Czeck Republic
...
/*created by Madhulata*/

function populateCountriesEdit(countryElementId, selectedValue){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var countryElement = document.getElementById(countryElementId);
	...
	countryElement.selectedIndex = country_arr.indexOf(selectedValue);
	
	countryElement.options[0] = new Option(selectedValue);
	//$('.countryElement option[value=selectedValue]').attr('selected','selected');
...
function populateStateEdit(countryElementId,stateElementId,selectedValue,selectedValue2){
	
	
	//var selectedCountryIndex = document.getElementById( countryElementId ).selectedIndex;
	var selectedCountryIndex = country_arr.indexOf(selectedValue2)+1;

	var stateElement = document.getElementById( stateElementId );
	
	//stateElement.length=0;	// Fixed by Julian Woods
	//stateElement.options[0] = new Option('Select State','-1');
	stateElement.selectedIndex = country_arr.indexOf(selectedValue);
	stateElement.options[0] = new Option(selectedValue);
...
function populateStatesOnchange( countryElementId, stateElementId, countryValue ){
	//setting value in hidden path
	document.getElementById("ctr" ).value=countryValue;
...
if (selectedCountryIndex==0){
	...
	selectedCountryIndex= country_arr.indexOf(countryValue)+1;
	}
