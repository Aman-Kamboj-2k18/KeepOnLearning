	...
	<div class="container-fluid">
								...
								<c:forEach items="${customerList}" var="cus">
									...
									<tr>
										...
										<td><b><form:radiobutton path="id" name="cusId"
													value="${cus.id}" onclick="onclickRadio('${cus.id}','${cus.customerName}')" /></b></td>
		...
		<script>
		 ...
		 function searchCustomer() {
			    ...
			    {   
			    $("#fdForm").attr("action", "searchCustomerTdsReportList");
			    $("#fdForm").submit();
			...
			function onclickRadio(value) {
				...
				$("#fdForm").attr("action", "customerTdsReport?customerId="+id);
				$("#fdForm").submit();
