...
<div class="right-container" id="right-container">
        <div class="container-fluid">
			...
			<form:form  class="form-horizontal" id="modeOfPayment"
				name="modeOfPayment" action="addModeOfPayment" autocomplete="off"  method="post"
...
<%-- 				 <a href="apprMng" class="btn btn-success"><spring:message code="label.back"/></a> --%>
					<input type="submit" size="3" onclick="return addModeOfPayment()"  value="<spring:message code="label.add"/>" class="btn btn-primary">
					...
					<tbody>
							...
							<c:forEach items="${allList}" var="list">
								...
								<tr>
									...
									<c:if test="${list.isVisibleInCustomerSide==1}">
									<td>Yes</td>
									</c:if>
									<c:if test="${list.isVisibleInCustomerSide==0}">
									<td>No</td>
									</c:if>
									
									
									<c:if test="${list.isVisibleInBankSide==1}">
									<td>Yes</td>
									</c:if>
									<c:if test="${list.isVisibleInBankSide==0}">
									<td>No</td>
									</c:if>
    ...
    function addModeOfPayment() {
		...
		validationError.innerHTML="";
		  ...
		  debugger;
			    ...
			    if(submit==true){
			    	 $("#fdForm").attr("action", "addModeOfPayment");
					    $("#fdForm").submit();
			    }
			    else{
			    	return false;
