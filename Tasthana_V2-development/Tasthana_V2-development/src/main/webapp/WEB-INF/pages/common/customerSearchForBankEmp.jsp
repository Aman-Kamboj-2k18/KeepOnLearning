...
<div class="bank-emp-list">
	<div class="header_customer">
		<h3 align="center"><spring:message code="label.suspend"/></h3>
	</div>
	<form:form name="suspendCustomerUpdate" action="suspendCustomerConfrimForAdmin"
		method="post" commandName="endUserForm" onsubmit="return val();" autocomplete="off">
		...
		<div class="space-10"></div>
			<table align="center" style="position: relative;right: 3.3%;">
				<tr>
					...
					<td><a href="customerSuspendFromAdmin" class="btn btn-success"><spring:message
