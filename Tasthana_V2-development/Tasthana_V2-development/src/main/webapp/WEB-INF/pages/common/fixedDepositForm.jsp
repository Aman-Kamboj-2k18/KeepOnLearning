				...
				if (fdAmount == "") {
					...
					if('${baseURL[1]}' == 'common'|| '${baseURL[0]}' == 'common'){
						...
						.getElementById('branchCode').value;
						 if (branch == "select" && '${role.role}' != 'ROLE_USER') {
					...
					if(paymentMode_ == "Net Banking" || paymentMode_ == "Card Payment" || paymentMode_ == "cash" || paymentMode_ ==  'Cheque' || paymentMode_ ==  'DD'){
...
/* 
		...
		var isNomineeMandatory=$('#isNomineeMandatory').val();
				...
				if($("#branchCode").length >0 && '${role.role}' != 'ROLE_USER'){
...
var paymentModeOnMaturity=$('#paymentModeOnMaturity').val();
			...
			document.getElementById('differentBankRadioMr').style.boxShadow = "none";
				...
				if (paymentMode == 'Select') {
					...
					document.getElementById('cardType_').value = paymentMode;
					...
					<div id="depositDetails" class="collapse in">
						<div class="col-md-6" style="padding-top: 7px;">
							...
							<div class="form-group" id="maturityIns">
								...
								<div class="col-md-6">
									<form:select id="maturityInstructionId"
										...
										<form:option value="autoRenew" selected="selected">
							...
							<div class="form-group" id="branchDIV" style="display: none;">
								...
								<div class="col-md-6" >
									<form:input id = "branchCode"  class="form-control" path="branchCode" readonly = "readonly" value="${branchCode} - ${branchName }"/>
									<%-- <form:select id="branchCode"
										...
										<c:out value="${list.branchCode}"></c:out>
										</c:forEach>
										 <option value = "${branchCode}">${branchCode}</option>
										<foreach($branchs in $branch) 
							            <option value = "$branchs.getBranchCode()" selected ="selected" >${branchCode}</option> 
							          </foreach>
                                     </form:select> --%>
							...
							<div class="form-group" id = "areaDIV" style="display: none;">
								...
								<div class="col-md-6">
									...
									<form:input path="depositArea" type="text"
										class="input form-control" id="depositArea" 
...
<div class="header_customer col-sm-12 col-md-12 col-lg-12"
					...
					<div id="payOffDetails" class="collapse">
						...
						<input type="button" onclick="resetPayoffDetails()"
							style="margin-bottom: 9px; margin-right: 9px; margin-top: -25px;"
							class="btn btn-warning pull-right" value="Reset" />
					</div>
						...
						<div class="form-group" id="everyMonthInt">
							...
							<div class="col-sm-7" style="padding-top: 8px;">
								 <label id="fd1" for="radio"> <form:radiobutton
										...
										onclick="inLinkedAccount()" checked="checked"></form:radiobutton>
									Yes <label id="fd3"
									for="radio"> <form:radiobutton
					...
					<div id="paymentDetails" class="collapse" style="float:left;width:100%;">
						<div class="form-group">
							...
							<div class="col-md-6">
								<form:select id="paymentMode" path="depositForm.paymentMode"
									...
									<form:option value="Select" mode="Select">Select</form:option>
						...
						<div style="display: none" id="cardDetailsTr">
							<div class="form-group">
							<form:hidden path="depositForm.cardType"  id ="cardType_"/>
						...
						<input type="button" onclick="resetPaymentDetails()"
							class="btn btn-warning pull-right" value="Reset"
							style="margin-right: 9px; margin-bottom: 10px; margin-top: -25px;" />
					</div>
...
<table align="center" class="f_deposit_btn">
							...
							<tr>
								<td>
									...
									class="btn btn-info" style="margin-left: 2px; margin-top: -15px;" value="Submit">
								</td>
</tr>
</table>
					</div>
