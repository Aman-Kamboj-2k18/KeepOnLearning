		...
		<div class="Flexi_deposit">
			...
			<div class="flexi_table" style="margin-top: 7px;">
				<form:form action="confirmReverseEmiForBankEmp"
					...
					<form:hidden path="userName" id="userName" value="${model.customer.userName}"/>
								...
								<div class="col-md-6">
									<form:input type="text" id="branchCode"
										path="branchCode" class="form-control"
										 readonly="true" value="${branchCode} - ${branchName}"/>
...
function getEMIAmount(){
    ...
    var dataString = 'tenureType=Day'
	  ...
	  $.ajax({  
	    type: "GET",  
	    url: "<%=request.getContextPath()%>/common/getEMIAmount", 
...
function checkPanAndAdhaar(){
	    ...
	    var result = 0;
		    $.ajax({  
 		    async: false,
		      type: "GET",  
		      url: "<%=request.getContextPath()%>/common/panCardValidation", 
		      contentType: "application/json",
		      dataType: "json",
