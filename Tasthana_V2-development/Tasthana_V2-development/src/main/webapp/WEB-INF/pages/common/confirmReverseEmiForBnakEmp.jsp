...
<div class="right-container" id="right-container">
 ...
 --%>
					...
					<form:hidden path="remarks" id="remarks" />
					<form:hidden path="reverseEmiCategory" value="Fixed Tenure" />
					...
					<div id="depositDetails" class="collapse in">
						...
						<div class="col-md-6">
							...
							<c:if test="${fixedDepositForm.daysValue!=null}">
								<div class="form-group">
									...
									<div class="col-sm-6">
										...
										<input value="${fixedDepositForm.daysValue}"
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<form:input path="gestationPeriod" value="${gestationPeriod}"
										class="myform-control" id="gestationPeriodId" />
 ...
 --%>
							...
							<div class="col-md-6">
								...
								<%-- div class="form-group" id="transferModeTr"> <label
								class="control-label col-sm-4" for=""><spring:message
								code="label.transfer" /></label> <div class="col-sm-6">
							...
							value="${fn:split(accountBalance, ',')}" /> --%>
								...
								<c:forEach items="${bankAccountTypeList}" var="accType"
									...
									<div class="col-sm-6 col-xs-6">
										...
										<div class="form-group">
											<label class="col-md-4 control-label">Beneficiary
												Name</label>
											<div class="col-md-6">
								...
								<div id="bankDetailsTr">
									<div class="form-group" id="chequeNoTr">
										<label class="col-md-4 control-label"> <c:if
											...
											<c:if
												test="${fixedDepositForm.depositForm.paymentMode=='DD'}">DD Number</c:if></label>
										<div class="col-md-6">
											<form:input path="depositForm.chequeNo"
												class="myform-control" id="chequeNo" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-4 control-label"> <c:if
											...
											<c:if
												test="${fixedDepositForm.depositForm.paymentMode=='DD'}">DD Date</c:if></label>
										<div class="col-md-6">
											<form:input path="depositForm.chequeDate"
												value="${todaysDate}" readonly="true" class="myform-control"
												id="chequeDate" />
										</div>
									</div>
									<div class="form-group">
								...
								<div id="cardDetailsTr">
									<div class="form-group">
										...
										<div class="col-md-6">
											...
											<form:input path="depositForm.cardType"
												class="myform-control" readonly="true" />
						...
						<div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10"
								...
								<a
									href="reverseEmiForBankEmp?userName=${fixedDepositForm.userName}&productId=${fixedDepositForm.productConfigurationId}"
...
.form-horizontal .control-label {
	...
	<script>
		...
		function goBack() {
			...
			$("#confirmForm").attr("action", "reverseEmiForBankEmp");
			$("#confirmForm").submit();
