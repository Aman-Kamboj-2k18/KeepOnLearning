          ...
          <div class="list-of-rates" style="border: none;padding: 0;box-shadow: none;background: none;">
			<div class="header_customer">	
				...
				<div class="form-group" id="states">
							<label class="col-md-4 control-label" style="padding-top: 16px;">State<span style="color: red">*</span></label>
							...
							<label class="col-md-4 control-label" style="padding-top: 6px;">Urban Or Rural</label>
							<div class="col-md-6" style="margin-top: 5px; margin-left: 5px;">

								<label for="radio"> <form:radiobutton path="urbanOrRural"
										id="urban" name="urbanOrRural" value="Urban" onclick="citizenFun()" checked="true"></form:radiobutton></label>
								Urban
								<label for="radio"> <form:radiobutton path="urbanOrRural"
										id="rural" name="urbanOrRural" value="Rural"
						...
						<label class="col-md-4 control-label" style="padding-top: 16px;">City/Town</label>
						<div class="col-md-4">
				...
				<div class="form-group">
						<label class="col-md-4 control-label" style="padding-top: 16px;">Area</label>
						<div class="col-md-4">
				...
				<div class="form-group">
						<label class="col-md-4 control-label" style="padding-top: 16px;"><spring:message
...
<%-- 				 <a href="apprMng" class="btn btn-success"><spring:message code="label.back"/></a> --%>
				 ...
				 <table class="table table-bordered"  align="center" id="my-table" style="width: 95%;">
					...
					<tbody>
							...
							<c:forEach items="${allList}" var="list">
								...
								<tr>
									...
									<td><c:out value="${list.urbanOrRural}"></c:out></td>
...
$(document).ready(function(){
    ...
    function citizenFun(){
    	...
    	var NRIRadioChecked = document.getElementById("rural").checked;
    	if(RIRadioChecked==true){
    		...
    		$('#setCategory option').each(function(){
    			if($(this).attr('urbanOrRural')=="Urban"){
    				$(this).show();
    			}
    			if($(this).attr('urbanOrRural')=="Rural"){
    				$(this).hide();
    			}
    		});
    	}
