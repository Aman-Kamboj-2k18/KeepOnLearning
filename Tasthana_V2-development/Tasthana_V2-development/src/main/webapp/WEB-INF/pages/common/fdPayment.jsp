...
<div class="form-group">
    <div class="col-md-4"></div>		 
							<div class="col-md-8">
								...
								<a href="customerPayment?menuId=${menuId}" class="btn btn-info">Back</a> <input type="button" id="goBtn" class="btn btn-info" onclick="search()" data-toggle="tooltip" value="Go" disabled="" title="Please select mode of payment and deposit">
