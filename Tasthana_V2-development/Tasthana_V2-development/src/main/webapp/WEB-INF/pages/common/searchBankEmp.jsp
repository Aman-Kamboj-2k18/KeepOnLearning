			...
			<div class="flexi_table">
				<form:form class="form-horizontal" id="fdForm" method="post"
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<form:input path="contactNo" id="contactNo" class="form-control" placeholder="Enter Contact Number" />
						...
						<c:if test="${! empty endUserList}">
							<table class="table table-striped table-bordered">
								...
								<c:forEach items="${endUserList}" var="user">
									...
									<tr>
										<td><b> <c:out value="${user.displayName}"></c:out></b></td>
										<td><b> <c:out value="${user.email}"></c:out></b></td>
										<td><b> <c:out value="${user.contactNo}"></c:out></b></td>
										<td><b><a href="suspendBankEmp?id=${user.id}">Select</a></b></td>
