				...
				<div class="form-group" id = "minIntAmtForTDSDeductionDIV">
					...
					<div class="col-md-6">
						<form:input id="minIntAmtForTDSDeduction"
							...
							type="number" step=".01"></form:input>
					</div>
				</div>
					...
					<div class="col-md-6">
						<span id="validaionError" style="display: none; color: red"><spring:message
							...
							style="display: none; color: red"><spring:message
								code="label.radioError" /> </span> <a href="customerConfiguration?menuId=${menuId}"
...
$( document ).ready(function() {
	...
	var nriAccountType_ = $("#nriAccountType").val();
	var minIntAmtForTDSDeduction = document.getElementById('minIntAmtForTDSDeduction');
	
	if(nriAccountType_ == 'NRE' || nriAccountType_ == 'PRP' || nriAccountType_ == 'FCNR'){
		$("#minIntAmtForTDSDeductionDIV").hide();
	}else{
		$("#minIntAmtForTDSDeductionDIV").show();
	}
