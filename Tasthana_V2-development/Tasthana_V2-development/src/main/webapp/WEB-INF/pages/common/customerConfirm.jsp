				...
				<div class="add-customer-table">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<fmt:formatDate value="${customerForm.dateOfBirth}" pattern="dd/MM/yyyy" var="dateOfBirth"/> 
								<form:input pattern="dd/MM/yyyy" path="dateOfBirth" value="${dateOfBirth}" class="myform-control"
									readonly="true"></form:input>
							</div>
						</div>
						<div class="form-group">
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<p align="center" style="padding-top: 10px;">
							<a href="addCustomer?menuId=${menuId}" class="btn btn-success"><spring:message
