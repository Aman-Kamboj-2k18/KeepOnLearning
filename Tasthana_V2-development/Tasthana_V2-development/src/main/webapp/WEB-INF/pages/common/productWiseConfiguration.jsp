									...
									<div id="gernaltab" class="tab-pane active">
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 7px; margin-left: -10px;">Interest
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														...
														Maximum Online Deposit Limit<span style="color: red">*</span>
													</label>
													<div class="col-md-6" style="margin-left: -23px;">
														<form:input id="maximumOnlineDepositLimit" placeholder=""
															path="maximumOnlineDepositLimit" class="myform-control"
															onkeypress="numberValidation(event)" style="width: 106%;" />
											...
											<div class="col-md-6" style="margin-left: -24px;">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 7px; text-align: -webkit-right; margin-left: -44px;">Payment
														Mode for Maturity/Payout<span style="color: red">*</span>
													</label>
													<div class="col-md-6" style="margin-left: -15px;">
									...
									<div id="overdraft" class="tab-pane">
										<div class="col-md-12" style="margin-left: 25px;">
											...
											<div class="form-group" style="margin-bottom: 2px;">
												...
												<div class="col-md-2">
													<form:select path="isOverdraftFacilityAvailable" id="isOverdraftFacilityAvailable"
														class="myform-control" onchange="populateOverDraftFacility()">
														<form:option value="1">Yes</form:option>
														<form:option value="0">No</form:option>
													</form:select>
											...
											<div id="higherInterestRateDiv" class="form-group" style="margin-bottom: 2px;">
												<label class="col-md-5"
													style="padding-top: 6px; text-align: -webkit-right;">Interest
													Rate higher than the Deposit Rate in %<span
													style="color: red">*</span>
												</label>
												<div class="col-md-2">
											...
											<h5 align="left" style="font-size: 1.15em; margin: 25px auto -10px; font-weight: 700;">Overdraft Limit In Bank</h5>
											<div style="padding-bottom: 15px; border-bottom: 1px dotted #ccc;width: 700px;"></div>


											
											<div id="overdraftPercent">
												<div class="form-group" id="minimumOverdraftPercentageDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 17px; text-align: -webkit-right;">Min
														Limit Overdraft Percentage<span style="color: red">*</span>
													</label>
													<div class="col-md-2">
														<form:input id="minimumOverdraftPercentage"
															path="minimumOverdraftPercentage" class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div class="form-group" id="maximumOverdraftPercentageDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 17px; text-align: -webkit-right;">Maximum
											...
											<h5 align="left" style="font-size: 1.15em; margin: 25px auto -10px; font-weight: 700;">Online Overdraft Limit</h5>
											<div style="padding-bottom: 15px; border-bottom: 1px dotted #ccc;width: 700px;"></div>
											

											<div id="onlineDraftPercent">
												<div id="onlineMinimumOverdraftPercentageDiv"
													class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 17px; text-align: -webkit-right;">Online
														Min Limit Overdraft Percentage<span style="color: red">*</span>
													</label>
													<div class="col-md-2">
														<form:input id="onlineMinimumOverdraftPercentage"
															path="onlineMinimumOverdraftPercentage"
															class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div id="onlineMaximumOverdraftPercentageDiv"
													class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 17px; text-align: -webkit-right; ">Online
														Maximum Limit Overdraft Percentage<span style="color: red">*</span>
													</label>
													<div class="col-md-2">
														<form:input id="onlineMaximumOverdraftPercentage"
															path="onlineMaximumOverdraftPercentage"
															class="myform-control"
															onkeypress="amountValidation(event)" />
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 16px; text-align: -webkit-right;">Is
														Top-up Allowed<span style="color: red">*</span>
													</label>
													<div class="col-md-6">
														<form:select path="isTopupAllowed" class="myform-control"
															onchange="disableRemaningFields(event)" style="width: 108%;">
															<form:option value="1">Yes</form:option>
															<form:option value="0">No</form:option>
														</form:select>
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 7px; text-align: -webkit-right;">Prevention
														of Top-up Before Maturity<span style="color: red"></span>
													</label>
													<div class="col-md-6">
														<select id="preventionOfTopUpBeforeMaturity"
															name="preventionOfTopUpBeforeMaturity" class="myform-control" style="width: 108%;">
															<option value="">Day</option>
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 16px; text-align: -webkit-right;">Min
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px; margin-top: 7px;">
													<label class="col-md-4"
														style="padding-top: 17px; text-align: -webkit-right;">Penalty
														for Top-up<span style="color: red"></span>
													</label>
													<div class="col-md-6" style="padding-top: 15px;">

														<input id="percentage" type="radio" name="same"
															value="percentage"> In Percentage (%) &nbsp;&nbsp; <input
												...
												<div id="penaltyAmountDIV" class="form-group"
													...
													<div class="col-md-6">
														<form:input id="penaltyAmountForTopup" placeholder=""
															...
															onkeypress="amountValidation(event)" style="width: 112%;" />
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 17px; text-align: -webkit-right;">Non
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													...
													<div class="col-md-6">
														...
														<form:select id="modificationBasis"
															path="modificationBasis" class="myform-control" style="width: 110%;">
															<form:option value="">Select</form:option>
												...
												<div class="form-group" style="margin-bottom: 2px;">
													...
													<div class="col-md-6">
														<form:input id="maximumLimitOfModification" placeholder=""
															...
															onkeypress="numberValidation(event)" style="width: 110%;" />
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 4px; text-align: -webkit-right;">Modification
														Penalty<span style="color: red"></span>
													</label>
													<div class="col-md-6" style="padding-top: 6px;">
														<input id="percentageModification" type="radio"
															name="modification" value="percentModification">In Percentage (%) &nbsp;&nbsp; <input id="amountModification"
												...
												<div id="percentModificationDIV" class="form-group"
													style="margin-bottom: 2px; display: none;">
													<label class="col-md-4"
														style="padding-top: 17px; text-align: -webkit-right;">
														Penalty in %<span style="color: red">*</span>
													</label>
													<div class="col-md-6">
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													...
													<div class="col-md-6">
														<form:input id="incrementalWithdraw" placeholder=""
															...
															onkeypress="numberValidation(event)" style="width: 104%;" />
												...
												<div class="form-group" style="margin-bottom: 2px;">
													...
													<div class="col-md-2" style="width: 17.5%; margin-left: 9px; padding: 6px;">
...
<script>
	...
	function populateOverDraftFacility(){
		var isOverdraftFacilityAvailable = document.getElementById('isOverdraftFacilityAvailable').value;
		if(isOverdraftFacilityAvailable == 'Yes' || isOverdraftFacilityAvailable == "1"){
			$("#higherInterestRateDiv").show();
		}else{
			$("#higherInterestRateDiv").hide();
		}
	...
	function submitForm() {
		...
		/* var isOverdraftFacilityAvailable = document.getElementById('isOverdraftFacilityAvailable').value;
		if(isOverdraftFacilityAvailable == 'Yes'){
		if ($("#higherInterestRate").val() == "") {
			$(".alert").removeClass("in").show();
			$(".alert").delay(2500).addClass("in").fadeOut(1600);
			$("#alertMessages").text("Interest Rate can not be empty!").show();
			flag = false;
			return flag;
		}
		}
 */
 var isOverdraftFacilityAvailable = document.getElementById('isOverdraftFacilityAvailable').value;
		if(isOverdraftFacilityAvailable == '1'){
			if ($("#higherInterestRate").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages").text("Interest Rate can not be empty!").show();
		...
		if ($("#maximumOnlineDepositLimit").val() == "") {
			$(".alert").removeClass("in").show();
			$(".alert").delay(2500).addClass("in").fadeOut(1600);
			$("#alertMessages").text(
					"Maximum Online Deposit Limit can not be empty!").show();
			flag = false;
			return flag;
		}

		/* var maxOnlineDepositAmount = 100000;

		if (parseInt($("#maximumOnlineDepositLimit").val()) > maxOnlineDepositAmount) {
			$(".alert").removeClass("in").show();
			$(".alert").delay(2500).addClass("in").fadeOut(1600);
			$("#alertMessages").text("Maximum Online deposit amount  should be less than 100000!").show();
			flag = false;
			return flag;
		}
 */
		...
		if ($("#paymentModeOnMaturity").val() == "") {
			$(".alert").removeClass("in").show();
			$(".alert").delay(2500).addClass("in").fadeOut(1600);
			$("#alertMessages").text("Please select payment mode option !")
					.show();
			flag = false;
			return flag;
		}
		...
		/* var isCheckedOverdraftPercentage = false;//$('#overdraftPercentage').prop('checked');
		if (isCheckedOverdraftPercentage) { */
			if ($("#minimumOverdraftPercentage").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages").text(
						"Minimum Overdraft Percentage  can not be empty!")
						.show();
				flag = false;
				return flag;
			}
			if ($("#maximumOverdraftPercentage").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages").text(
						"Maximum Overdraft Percentage  can not be empty!")
						.show();
				flag = false;
				return flag;
			}
		...
		/* } */
		/* var isCheckedOnlineOverdraftPercentage = false;
			//$('#onlsubmitFormineOverdraftPercentage').prop('checked');
		if (isCheckedOnlineOverdraftPercentage) { */
			if ($("#onlineMinimumOverdraftPercentage").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages")
						.text(
								"Online Minimum Overdraft Percentage  can not be empty!")
						.show();
				flag = false;
				return flag;
			}
			if ($("#onlineMaximumOverdraftPercentage").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages")
						.text(
								"Online Maximum Overdraft Percentage  can not be empty!")
						.show();
				flag = false;
				return flag;
			}
		...
		/* var isCheckedOverdraftAmount = $('#overdraftAmount').prop('checked');
		if (isCheckedOverdraftAmount) {
			if ($("#minimumOverdraftAmount").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages").text(
						"Minimum Overdraft Amount  can not be empty!").show();
				flag = false;
				return flag;
			}
			if ($("#maximumOverdraftAmount").val() == "") {
				$(".alert").removeClass("in").show();
				$(".alert").delay(2500).addClass("in").fadeOut(1600);
				$("#alertMessages").text(
						"Maximum Overdraft Amount  can not be empty!").show();
				flag = false;
				return flag;
			}
	...
	/* 	var isCheckedOverdraftAmount = $('#overdraftAmount').prop('checked');
		...
		/* if ($("#penaltyPercntForDepositConversion").val() == "") {
			...
			flag = false;
			return flag;
		}productWiseConfigurationForm */
		
		var  menuId = ${menuId};
		$("#productWiseConfigurationForm").attr("action", "productWiseConfiguration?menuId=" +menuId);
		$("#productWiseConfigurationForm").submit();
	...
	function disableRemaningFields(event) {
		...
		if (event.target.id == 'isTopupAllowed') {
			...
			if (isTop == "0") {
				...
				$('#maximumTopupAmount').attr('readonly', true);
				$('#incrementalPayment').attr('readonly', true);
				...
				$('#incrementalPayment').attr('readonly', false);
		...
		if (event.target.id == 'isWithdrawAllowed') {
			...
			if (isWith == "0") {
				...
				$('#isSlabBasedPenaltyRequiredForWithdraw').prop('disabled',
						true);
				$('#incrementalWithdraw').attr('readonly', true);
				...
				$("#LPMonthSelect").val("");
				$("#LPDaySelect").val("");
				$('#incrementalWithdraw').attr('readonly', false);
				$('#isSlabBasedPenaltyRequiredForWithdraw').prop('disabled',
						false);
	...
	$('input[type=radio]').change(function() {
		...
		/* if (this.value == 'overdraftAmount') {
			$("#overdraftAmount1").show();
			$("#overdraftPercent").hide();

			$("#minimumOverdraftPercentage").val("");
			$("#maximumOverdraftPercentage").val("");
			$("#defaultOverdraftPercentage").val("");

		}
		if (this.value == 'overdraftPercentage') {
			$("#overdraftAmount1").hide();
			$("#overdraftPercent").show();

			$("#minimumOverdraftAmount").val("");
			$("#maximumOverdraftAmount").val("");
			$("#defaultOverdraftAmount").val("");
		}

		if (this.value == 'onlineOverdraftAmount') {
			$("#onlineDraftAmount").show();
			$("#onlineDraftPercent").hide();
		...
		if (this.value == 'onlineOverdraftPercentage') {
			$("#onlineDraftAmount").hide();
			$("#onlineDraftPercent").show();

			$("#onlineMinimumOverdraftAmount").val("");
			$("#onlineMaximumOverdraftAmount").val("");
			$("#onlineDefaultOverdraftAmount").val("");
		}
 */
