...
<!-- 		<table class="table data jqtable example" id="my-table"> -->
		<div class="col-sm-6"><div style="float: left;margin-right: 80px;z-index: 100000 !important;"><a href="addDTAATaxRate?menuId=${menuId}" style="display:none;" class="btn btn-success"><spring:message
