						...
						<div class="tab-content">
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										...
										<div class="form-group" style="margin-bottom: 2px;">
										 ...
										 <div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4" style="padding-top: 7px; margin-left: -5px;">
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6" style="margin-left: -15px;">
												<form:input id="minimumDepositAmount" placeholder=""
													...
													onkeypress="numberValidation(event)" style="width: 101%;" />
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6" style="margin-left: -15px;">
												<form:select path="defaultCurrency" id="currency"
													class="myform-control" style="width: 101%;">
							...
							<div id="overdraft" class="tab-pane">
									 <div class="col-md-12" style="margin-left: 25px;">
												...
												<div class="form-group" style="display:none;margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Overdraft<span style="color: red"></span>
													</label>
													<div class="col-md-6">

														<input checked id="overdraftPercentage" type="radio" name="online"
												...
												<div id="onlineDraftPercent">
												 <div id="onlineMinimumOverdraftPercentageDiv" class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 16px; text-align: -webkit-right;">Online Min
													Limit	Overdraft Percentage<span style="color: red">*</span>
													</label>
													<div class="col-md-2">
									...
									<div class="col-md-6">
										<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-4" style="padding-top: 16px; text-align: -webkit-right;">Is Top Allowed<span
												style="color: red">*</span></label>
											<div class="col-md-6">
												<form:select path="isTopupAllowed" class="myform-control" onchange="disableRemaningFields(event)" style="width: 106%;">
													<form:option value="1">Yes</form:option>
													<form:option value="0">No</form:option>
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-3" style="width: 21%;margin-left: -2px;">
											...
											<div class="col-md-3" style="width: 23%; margin-left: -30px;">
											...
											<div class="col-md-3" style="width: 20%; margin-left: -30px;">
									...
									<div class="col-md-6">
										...
										<div class="form-group" style="margin-bottom: 2px; margin-top: 7px;">
											...
											<div class="col-md-6">
												...
												<input id="percentage" type="radio" name="same" value="percentage" style="padding-top: 6px;"> Percent (%) &nbsp;&nbsp; <input id = "amount" type="radio" name="same" value="amount"> Penalty Amount


											</div>
										</div>
										<div id = "penaltyAmountDIV" class="form-group" style="margin-bottom: 7px;">
											<label class="col-md-4" style="padding-top: 15px; text-align: -webkit-right;">Penalty Amount for
												Top-up<span style="color: red">*</span>
											</label>
											<div class="col-md-6">
												<form:input id="penaltyAmountForTopup" placeholder=""
													path="penaltyAmountForTopup" class="myform-control"
													onkeypress="amountValidation(event)" style="width: 111%;" />


											</div>
										</div>
										<div id = "penaltyPercentDIV" class="form-group" style="margin-bottom: 10px;">
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6">
												<form:input id="penaltyPercntForDepositConversion"
													...
													class="myform-control" onkeypress="amountValidation(event)" style="width: 111%;" />
									...
									<div class="col-md-6">
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6">
												...
												<form:select id="modificationBasis" path="modificationBasis"
													class="myform-control" style="width: 111%;">
													<form:option value="">Select</form:option>
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6">
												<form:input id="maximumLimitOfModification" placeholder=""
													...
													onkeypress="numberValidation(event)" style="width: 111%;" />
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6" style="padding-top: 10px;">
												<input id = "percentageModification" type="radio" name="modification" value="percentModification"> In Percent (%) &nbsp;&nbsp; <input id = "amountModification" type="radio" name="modification" value="amountModification"  checked="true"> In Amount 
											</div>
										</div>
								...
								<div class="col-md-12">
									...
									<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="padding-top: 16px; text-align: -webkit-right;">Is Premature Closing Allowed<span
												style="color: red">*</span></label>
											<div class="col-md-6" style="margin-left: -15px;">
												<select name="isPrematureClosingioAllowedForWithdraw" class="myform-control" onchange="disableRemaningFields(event)" style="width: 111%;">
										...
										<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="padding-top: 16px; text-align: -webkit-right;">Is Withdraw Allowed<span
												style="color: red">*</span></label>
											<div class="col-md-6" style="margin-left: -15px;">
												<form:select path="isWithdrawAllowed" class="myform-control" onchange="disableRemaningFields(event)" style="width: 111%;">
													<form:option value="0">No</form:option>
													<form:option value="1">Yes</form:option>
										...
										<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="padding-top: 7; text-align: -webkit-right;">Locking Period For
									...
									<div class="col-md-6">
										<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="padding-top: 6px; text-align: -webkit-right;">Is Slab Based
										...
										<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="text-align: -webkit-right;">Prevention of Withdraw Before Maturity<span style="color: red"></span>
											</label>
											<div class="col-md-6">
