					...
					<div class="col-sm-12">
						...
						<div class="add-customer-table col-sm-6 col-xs-12">
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="displayName">Display Name<span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="roleDisplayName" class="form-control"
						...
						<%-- <div class="add-customer-table col-sm-6 col-xs-12">
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="displayName">Menu<span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:select path="menu" multiple="multiple">
									<c:forEach items="${menuList}" var="menu">								
								
									<form:checkbox path="menu" value="${menu.id}"/> <b>${menu.name}</b>
							...
							<div class="form-group">
								<label class="control-label col-sm-4">Permissions<span style="color: red">*</span></label>
								<div class="col-sm-8">
										<form:select path="menu" multiple="multiple">
									<c:forEach items="${permissionList}" var="permission">								
								
									<form:checkbox path="permission" value="${permission.id}"/> <b>${permission.action}</b>
