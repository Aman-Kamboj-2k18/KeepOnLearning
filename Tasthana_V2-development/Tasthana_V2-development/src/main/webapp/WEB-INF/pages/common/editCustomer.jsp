			...
			<form:form action="editcustomerPost" name="fixedDeposit"
					...
					<div>
                      ...
                      <c:if test="${accDetails.citizen=='NRI'}">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
								<fmt:formatDate value="${customerForm.dateOfBirth}" pattern="dd/MM/yyyy" var="dateOfBirth"/>
									<form:input path="dateOfBirth" placeholder="Select Date"
										class="form-control" value="${dateOfBirth}" id="datepicker" required="true"
										readonly="true" />
								</div>
							</div>
							<div class="form-group">
				...
				<p align="center" style="padding-top: 10px;">
					...
					<p align="center" style="padding-top: 10px;">
						...
						<a href="viewCustomerList?menuId=${menuId}" class="btn btn-success"><spring:message
...
debugger;
		var accType=$('#accountType0').val();
      	...
      	if(accType==accType1 && accType1!=undefined){
