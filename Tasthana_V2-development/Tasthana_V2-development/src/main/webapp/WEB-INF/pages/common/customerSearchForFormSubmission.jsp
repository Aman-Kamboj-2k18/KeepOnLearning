								...
								<c:forEach items="${customerList}" var="cus">
									...
									<tr>
										...
										<td><b><form:radiobutton path="id" name="cusId"
													value="${cus.id}" onclick="onclickRadio('${cus.id}')" /></b></td>
					...
					<input type="hidden" id="customerId"/>
					 ...
					 <div class="form-group">
						<div class="col-md-offset-4 col-md-8">
								...
								id="goBtn" onclick=" return validateForm()"  disabled="disabled"
		...
		<script>
		 ...
		 var custIdVal ;
			function onclickRadio(value) {
				...
				//$("#fdForm").attr("action", "formSubmission?customerId="+id);
				//$("#fdForm").submit();
		 	...
		 	function validateForm() {
			   ...
			   // alert("in...."+id)
				...
				$("#fdForm").attr("action", "formSubmission?customerId="+custIdVal);
				$("#fdForm").submit();
