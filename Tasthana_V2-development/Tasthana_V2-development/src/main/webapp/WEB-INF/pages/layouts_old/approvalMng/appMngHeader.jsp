  ...
  <nav class="navbar navbar-inverse top-bar navbar-fixed-top">
    <div class="container-fluid ab_bg">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#"><!-- <img src="" width="90%"> -->TASTHANA </a>
			<span class="menu-icon" id="menu-icon"><i class="fa fa-bars" aria-hidden="true" id="chang-menu-icon"></i></span>
		</div>
		<div class="collapse navbar-collapse navbar-right" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-globe" aria-hidden="true"></i> Languages          
				   <span class="caret"></span></a>
					<ul class="dropdown-menu cust-dropdown" style="height: 213px;overflow-y: scroll;">
				...
				<li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-user" aria-hidden="true"></i> <spring:message code="label.welcome" /> ${requestCurrentUser.displayName}        
				   <span class="caret"></span></a>
					<ul class="dropdown-menu cust-dropdown">
						<li> <a href="editAMProfile?id=${requestCurrentUser.id}"><spring:message code="label.myProfile"/></a></li>
      ...
      <!-- begin SIDE NAV USER PANEL -->
		<div class="left-sidebar" id="show-nav">
			...
			<ul id="side" class="side-nav">
					<li class="panel"><a href="apprMng"><spring:message code="label.home"/></a> </li>
					<li class="panel"><a id="panel1" href="#2" data-toggle="collapse" data-target="#rates"><spring:message code="label.Approvals" /><i class="fa fa-chevron-left pull-right" id="arow1"></i> </a>
						<ul class="collapse nav" id="rates">
							<li><a href="bankEmpApprov"><spring:message code="label.bankEmpApp" /></a></li>
							<li><a href="customerApprovalList"><spring:message code="label.custApp" /></a></li>
							<li><a href="fdPendingList"><spring:message code="label.fd" /></a></li>
						</ul>
					</li>
