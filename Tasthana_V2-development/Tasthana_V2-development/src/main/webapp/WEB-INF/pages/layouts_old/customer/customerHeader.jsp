				...
				<ul id="side" class="side-nav">
					...
					<li class="panel"><a id="panel1" href="#2"
						data-toggle="collapse" data-target="#rates"><spring:message
								code="label.deposit" /><i class="fa fa-chevron-left pull-right"
							id="arow1"></i> </a>
						<ul class="collapse nav" id="rates">
							<li><a href="newDeposit"><spring:message
										code="label.newDeposit" /></a></li>
							<li><a href="jointConsortiumDeposit"><spring:message
										code="label.jointConsortium" /></a></li>
							<li><a href="fdCustomerList"><spring:message
					...
					<li class="panel"><a href="fdListForFundTransfer"><spring:message
								code="label.fundTransfer" /></a>
						<ul>

						</ul></li>
					<li class="panel"><a href="withDrawDepositSearch"><spring:message
								code="label.withDrawFD" /></a></li>
