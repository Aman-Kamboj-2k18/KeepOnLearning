		...
		<div class="Flexi_deposit">
			...
			<div class="flexi_table">
				...
				<form:form class="form-horizontal" action="saveDeposit"
					...
					<form:hidden path="interestPayAmount" id="interestPayAmount" />
					...
					<form:hidden path="citizen" value="${customerDetails.citizen}"/>
					...
					<div id="depositDetails" class="collapse in">
						<div class="col-md-6">
							...
							<c:if test="${customerDetails.citizen=='NRI'}">
								<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<form:input path="emiAmount" type="number"
										class="myform-control" id="emiAmount" readonly="true" />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="">Area
							</label>
								
								<div class="col-sm-6">
									<form:input path="depositArea" class="myform-control" id="depositArea"
										value="${fixedDepositForm.depositArea}" readonly="true" />
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<%-- <div class="form-group">
								...
								<div class="col-sm-8">
									<c:set var="tenure"
										value="${fixedDepositForm.fdTenure} ${fixedDepositForm.fdTenureType}" />
									<input value="${tenure}" id="tenure" class="myform-control"
										readonly />
								</div>
							</div> --%>
							<div class="form-group">
					...
					<div id="nomineeDetails" class="collapse in">
						<div class="col-md-6" style="padding-top: 0;">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<form:input path="nomineePan" readonly="true"
										id="nomineePan" class="myform-control" style="text-transform:uppercase"></form:input>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for=""><spring:message
					...
					<div id="beneficiaryDetails" class="collapse in col-md-6">

						<c:if test="${! empty fixedDepositForm.benificiaryName}">
							<div style="margin-bottom: 10px; margin-left: 30px;">
								<!-- <b><h3>Beneficiary Details</h3></b> -->
							</div>
							...
							<c:forEach items="${bankAccountTypeList}" var="accType"
								...
								<div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label">Amount to
											transfer</label>
										<div class="col-md-6">
					...
					<div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10"
								...
								<a
									href="reverseEmiFixedAmount?productId=${ fixedDepositForm.productConfigurationId}"
