									...
									<div class="col-md-6" style="margin-left: -24px;">
										...
										<div class="form-group" style="margin-bottom: 2px;">
											...
											<div class="col-md-6" style="margin-left: -15px;">
												...
												<form:select path="nomineeRequiredForEachAccHolder"
													class="myform-control">
													<form:option value="0">No</form:option>
													<form:option value="1">Yes</form:option>
								...
								<div class="form-group" style="margin-bottom: 2px;">
													...
													<div class="col-md-6" style="margin-left: -15px;">
														<select id="paymentMode" 
															name="paymentMode" class="myform-control">
								...
								<div class="col-md-12">
									...
									<div class="form-group" style="margin-bottom: 2px;">
											<label class="col-md-5" style="padding-top: 16px; text-align: -webkit-right;">Is Premature Closing Allowed<span
												style="color: red">*</span></label>
											<div class="col-md-6" style="margin-left: -15px;">
												<select name="isPrematureClosingAllowedForWithdraw" class="myform-control" onchange="disableRemaningFields(event)">
...
$(document).ready(function() {
	...
	var withdraw = "${productConfiguration.lockingPeriodForWithdraw}";
			...
			var paymentModeChange = "${productConfiguration.paymentMode}";
			if(paymentModeChange != ''){
				$("#paymentMode").val(paymentModeChange).change();
			}
