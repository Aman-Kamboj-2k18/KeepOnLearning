							...
							<div id="minimumAmountAndSavingDIV">
								<div class="form-group" style="clear: both; margin-top: 40px;">
									...
									<div class="col-md-5" style="margin-left: 5px;">
										...
										value = "${minAmount}"
											...
											id="minimumAmountRequiredForSweepIn" onkeypress="amountValidation(event)"/>
									</div>
								...
								<div class="form-group" style="clear: both; margin-top: 40px;">
									...
									<div class="col-md-5" style="margin-left: 5px;">
										...
										value = "${minSavingBal}"
											type="number" min="0" class="myform-control"
											id="minimumSavingBalanceForSweepIn" style="margin-top:-28px" onkeypress="amountValidation(event)"/>
									</div>
