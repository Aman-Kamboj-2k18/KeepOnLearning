...
<!-- 		<table class="table data jqtable example" id="my-table"> -->
		<div class="col-sm-6"><div style="float: left;margin-right: 80px;z-index: 100000 !important;"><a href="addDTAATaxRateFromVP" class="btn btn-success"><spring:message
									code="label.addCountryRates" /></a> </div></div>
		<table class="table example" id="my1-table" style="width: 65%; margin-left: 75px;">
			<thead>
				<tr>
					<th>Country</th>
					<th>Interest Rate %</th>
