...
<c:set var="baseURL" value="${fn:split(req,'/')}" />
		...
		function getDatess(year, state){
			...
			$('#mdp-demo').multiDatesPicker('removeDates', dates);
			 $.ajax({  
				    type: "GET",  
				    url: '<%=request.getContextPath()%>/vp/holidayConfigurationGetByYear?year='+parseInt(year)+'&state='+state, 
			...
			<form:form  commandName="holidayConfiguration" action = "stateHolidayConfiguration" method="post" id="holidayConfiguration" class="form-horizontal" autocomplete="off">
					...
					<div class="form-group">
						<label class="col-md-3 control-label" style="padding-top: 16px;">Year<span
								...
								<select name="year" onchange="getDates()" id="years"  class="myform-control">
					...
					<div class="form-group" id="states">
							...
							<div class="col-md-6">
							<form:select onchange= "getDates()" id="state" path="state"
					...
					<%-- <tbody>
						...
						<div style="display:none;" id="confirmDiv" class="form-group">
