									...
									<div id="gernaltab" class="tab-pane active">
										...
										<div class="col-md-12">
											...
											<div class="col-md-6" style="margin-left: -24px;">
												...
												<div class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 16px; text-align: -webkit-right; margin-left: -44px;">Payment
									...
									<div id="overdraft" class="tab-pane">
										<div class="col-md-12">
											...
											<div class="form-group" style="margin-bottom: 2px;">
												...
												<div class="col-md-6">
													<form:select path="isOverdraftFacilityAvailable"
														class="myform-control">
														<form:option value="1">Yes</form:option>
														<form:option value="0">No</form:option>
													</form:select>
											...
											<div class="form-group" style="margin-bottom: 2px;">
												<label class="col-md-4"
													style="padding-top: 6px; text-align: -webkit-right;">Overdraft<span
													style="color: red"></span>
												</label>
												<div class="col-md-6">

													<input id="overdraftPercentage" type="radio" name="online"
														value="overdraftPercentage"> In Percentage (%)<br>
													<input id="overdraftAmount" type="radio" name="online"
														value="overdraftAmount" checked="true"> In Amount
											...
											<div id="overdraftPercent">
												...
												<div class="form-group" id="defaultOverdraftPercentageDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-4"
											...
											<div id="overdraftAmount1" style="display: none">
												<div class="form-group" id="minimumOverdraftAmountDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-5"
													...
													<div class="col-md-6">
														<form:input id="minimumOverdraftAmount"
															path="minimumOverdraftAmount" class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div class="form-group" id="maximumOverdraftAmountDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Maximum
												...
												<div class="form-group" id="defaultOverdraftAmountDiv"
													style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Default
											...
											<div class="form-group" style="margin-bottom: 2px;">
												...
												<div class="col-md-6">
													...
													<input id="onlineOverdraftPercentage" type="radio"
														name="bank" value="onlineOverdraftPercentage"> In
													Percentage (%)<br> <input id="onlineOverdraftAmount"
														type="radio" name="bank" value="onlineOverdraftAmount"
											...
											<div id="onlineDraftPercent">
												<div id="onlineMinimumOverdraftPercentageDiv"
													...
													<label class="col-md-5"
														style="padding-top: 16px; text-align: -webkit-right; margin-left: -44px;">Online
												...
												<div id="onlineMaximumOverdraftPercentageDiv"
													class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Online
														Maximum Limit of Overdraft Percentage<span
														style="color: red">*</span>
													</label>
													<div class="col-md-6">
														<form:input id="onlineMaximumOverdraftPercentage"
															placeholder="" path="onlineMaximumOverdraftPercentage"
															class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div id="onlineDefaultOverdraftPercentageDiv"
													class="form-group" style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Online
														Default Overdraft Percentage <span style="color: red"></span>
													</label>
													<div class="col-md-6">
														<form:input id="onlineDefaultOverdraftPercentage"
															placeholder="" path="onlineDefaultOverdraftPercentage"
															class="myform-control"
															onkeypress="amountValidation(event)" />
											...
											<div style="display: none;" id="onlineDraftAmount">
												<div id="onlineMinimumOverdraftAmountDiv" class="form-group"
													style="margin-bottom: 2px;">
													<label class="col-md-5"
														style="padding-top: 16px; text-align: -webkit-right; margin-left: -44px;">Online
														Minimun Limit Overdraft Amount<span style="color: red">*</span>
													</label>
													<div class="col-md-6">
														<form:input id="onlineMinimumOverdraftAmount"
															path="onlineMinimumOverdraftAmount"
															class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div id="onlineMaximumOverdraftAmountDiv" class="form-group"
													style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Online
														Maximum Limit of Overdraft Amount<span style="color: red">*</span>
													</label>
													<div class="col-md-6">
														<form:input id="onlineMaximumOverdraftAmount"
															placeholder="" path="onlineMaximumOverdraftAmount"
															class="myform-control"
															onkeypress="amountValidation(event)" />
												...
												<div id="onlineDefaultOverdraftAmountDiv" class="form-group"
													style="margin-bottom: 2px;">
													<label class="col-md-4"
														style="padding-top: 6px; text-align: -webkit-right;">Online
														Default Overdraft Amount<span style="color: red"></span>
													</label>
													<div class="col-md-6">
														<form:input id="onlineDefaultOverdraftAmount"
															placeholder="" path="onlineDefaultOverdraftAmount"
															class="myform-control"
															onkeypress="amountValidation(event)" />
...
<script>
	...
	function submitForm() {
		...
		debugger;
		var isCheckedOnlineOverdraftPercentage = $('#onlineOverdraftPercentage')
				.prop('checked');
		...
		var isCheckedOverdraftPercentage = $('#overdraftPercentage').prop(
				'checked');
