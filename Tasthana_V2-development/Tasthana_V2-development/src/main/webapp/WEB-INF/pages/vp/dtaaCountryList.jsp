...
<div class="fd-list">
	...
	<div class="fd-list-table">
		...
		<div class="col-sm-6"><div style="float: left;margin-right: 80px;z-index: 100000 !important;">
			<a href="addCountryForDTAAFromVP" class="btn btn-success"><spring:message
...
<!-- 		<table class="table data jqtable example" id="my-table"> -->
		<table class="table example" id="my1-table" style="width: 65%; margin-left: 65px;margin-top: -25px;">
			<thead>
				<tr>
