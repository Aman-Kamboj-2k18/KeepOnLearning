	...
	<div class="container-fluid">
		...
		<div class="set-rate">
			...
			<form:form class="form-horizontal"
				action="confirmcustomerConfigurationFromVP" method="post"
...
<%-- 										<td><c:out value="${rate.id}"></c:out></td> --%>
										...
										<td><a
											href="editCustomerConfigurationFromVP?nriAccountType=${rate.nriAccountType}&citizen=${rate.citizen}&type=${rate.type}"
	   ...
	   if (charCode != 46 && charCode > 31 
		...
		function validation() {
			...
			$("#bankConfigurationForm").attr("action",
					"customerConfigurationFromVP?RIRadio=RI");
		...
		$(document)
				.ready(
						function() {
							...
							var tds = document.getElementBy */Id('tds');
