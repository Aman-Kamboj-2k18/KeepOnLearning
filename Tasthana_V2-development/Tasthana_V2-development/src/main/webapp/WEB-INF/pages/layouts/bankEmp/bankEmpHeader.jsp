...
<%-- 								code="label.home" /></a></li> --%>
				<li class="panel"><a href="dashboard"><spring:message
								code="label.home" /></a></li>
				
				<li class="panel"><a href="logindate"><spring:message
					...
					<li class="panel"><a id="panel1" href="#2"
						...
						<ul class="collapse nav" id="rates">
						   ...
						   <li><a href="duration"><spring:message
										code="label.slabOrDuration" /></a></li>
										
							<li><a href="viewRate"><spring:message
										code="label.interestRates" /></a></li>
						
							<li><a href="dtaaCountryRates"><spring:message
										code="label.dtaaCountryRates" /></a></li>
						...
						<%-- <li><a href="bankConfiguration"><spring:message
							...
							<%-- 							<li><a href="updateRates"><spring:message code="label.updateConfiguration" /></a></li> --%>
							
<!-- 							<li><a href="viewRate"><spring:message
										code="label.viewRate" /></a></li>
										<li><a href="schedulerConfiguration?jobName=">Task -->
<!-- 									Scheduling</a></li> -->
								<li><a href="calculator">Calculator</a></li>	
							<li><a href="showMonthEndProcess">Day End Process</a></li>
					...
					<li class="panel"><a id="panel2" href="#3"
						...
						<ul class="collapse nav" id="rates1">
							...
							<li><a href="customerList"><spring:message
										code="label.viewEditcustomer" /></a></li>
							<li><a href=searchCustomerForSweepConfiguration><spring:message
									code="label.customerConfigurationForSweepDeposit" /></a></li>
							
						</ul>
					</li>

					<li class="panel"><a href="newDeposit"><spring:message
								code="label.newDeposit" /></a>
					</li>
						<li class="panel"><a href="fdApprovedList"><spring:message 
...
<!-- 							<li class="panel"><a id="panel41" href="#21" -->
<!-- 								data-toggle="collapse" data-target="#createDeposit">Create -->
<!-- 									Deposit<i class="fa fa-chevron-left pull-right" id="arow4"></i> -->
<!-- 							</a> -->
<!-- 								<ul class="collapse nav" id="createDeposit"> -->
<%-- 									<li><a href="applyOnlineFD?depositType=single"><spring:message --%>
<%-- 								code="label.single" /></a></li> --%>
<%-- 									<li><a href="applyOnlineFD?depositType=joint"><spring:message --%>
<%-- 								code="label.jointConsortium" /></a></li> --%>
<%-- 									<li><a href="customerSearch"><spring:message --%>
<%-- 								code="label.annuity" /></a></li> --%>
<!-- 								</ul></li> -->
...
<!-- 						</ul></li> -->
					<li class="panel"><a id="panel5" href="#3"
						...
						<ul class="collapse nav" id="rates4">
							<li><a href="fdListBank"><spring:message
										code="label.fixedDepositList" /></a></li>
							<li><a href="clearanceList">Deposit Clearance</a></li>
							<li><a href="closeFDList"><spring:message
										code="label.closeFD" /></a></li>
							<li><a href="searchCustForModificationReport">Modification
									Report</a></li>
						</ul></li>
					...
					<li class="panel"><a id="panel6" href="#4"
						...
						<ul class="collapse nav" id="rates5">
							<li><a href="payment"><spring:message
										...
										<li><a href="bankPaymentOnMaturity">Bank Payment on Maturity</a></li>
							<li><a href="bankPayment"><spring:message
										code="label.bankPayments" /></a></li>
						</ul></li>
					<li class="panel"><a href="#7" data-toggle="collapse"
						data-target="#withdraws"><spring:message code="label.withdraw" /><i
							class="fa fa-chevron-left pull-right" id="arow6"></i></a>

						<ul class="collapse nav" id="withdraws">
							<li><a href="withDrawFDSearch"><spring:message
										code="label.withdraw" /> Deposit</a></li>
							<li><a href="withdrawSearch"><spring:message
										code="label.withdraw" /> List</a></li>
						</ul></li>

                   <li class="panel"><a href="issueOverdraft">Issue Overdraft</a></li>
                   ...
                   <li class="panel"><a href="withdrawOverdraft">Withdraw From Overdraft</a></li>
					...
					<li class="panel"><a href="allCustomersSaving">Credit
							Saving Account</a></li>
					<%-- <li class="panel"><a href="uploadFile"><spring:message
								code="label.upload" /></a></li>
					<li class="panel"><a href="formSubmission"><spring:message
								code="label.formSubmission" /></a></li>
								 --%>
					<li class="panel"><a id="panel12" href="#4"
						data-toggle="collapse" data-target="#uploadFormSubmition">Form
							15G/15H<i class="fa fa-chevron-left pull-right" id="arow12"></i>
					</a>
						<ul class="collapse nav" id="uploadFormSubmition">
							<li class="panel"><a href="uploadFile"><spring:message
										code="label.upload" /></a></li>
							<li class="panel"><a href="customerSearchForFormSubmission"><spring:message
										code="label.formSubmission" /></a></li>
						</ul></li>


                     <li class="panel"><a id="panel17" href="#17"
						data-toggle="collapse" data-target="#rates17"><spring:message
								code="label.deathCertifiacate" /><i
							class="fa fa-chevron-left pull-right" id="arow17"></i></a>
						<ul class="collapse nav" id="rates17">
							<li class="panel"><a href="deathIssue"><spring:message
								code="label.death" /></a></li>
							<li><a href="searchDeathCustomer"><spring:message
										code="label.deathCertificateList" /></a></li>
		 ...
		 --%>
					...
					<li class="panel"><a id="panel6" href="#4"
						...
						<ul class="collapse nav" id="reports">
						   ...
						   <li class="panel"><a href="searchJournal"><spring:message
										code="label.ledgerReport" /> </a></li>
										<li class="panel"><a href="searchAllLedgerByDate">All <spring:message
										code="label.ledgerReport" /> </a></li>
							...
							<li class="panel"><a href="closedTransaction"><spring:message
										code="label.closedTransaction" /></a></li>
							<li class="panel"><a href="interestReport">Interest
								<spring:message code="label.reports" />
							</a></li>
							<li class="panel"><a href="fdListforHolderWiseResort">Distribution
									Report</a></li>
							<li class="panel"><a href="depositSummary">Deposit
                                    Summary</a></li>
							<li class="panel"><a href="unSuccessfulPayOffDetails">Unsuccessful
									Payoff Details</a></li>
							<li class="panel"><a href="searchBankPayment"><spring:message
                                         code="label.bankPaymentDetails" /></a></li>
<%-- 							<li class="panel"><a href="searchCustomerTdsReport"> <spring:message --%>
<%-- 										code="label.custTdsReport" --%>
<%-- 										/> --%>
							<li class="panel"><a href="customerTdsReport"> <spring:message
          							code="label.custTdsReport"
          />
							</a></li>
						</ul></li>
					<!-- <li class="panel"><a href="depositRate">Excel Import</a></li> -->
 
			<li class="panel"><a href="bulkDeposit">Upload Bulk Deposit</a></li>
				</ul>
			...
			$(document).ready(function() {
				...
				$("#panel11").click(function() {
				 ...
				 $("#panel17").click(function() {
					$("#arow17").toggleClass("fa-chevron-left");
					$("#arow17").toggleClass("fa-chevron-down");
				}); 
