...
<div class="confirm-edit-am-profile">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		...
		<form:form name="amDetails" action="updateAMDetails"
			...
			<table style="margin:0px auto;" width="600">
				...
				<tr>
					...
					<td><form:input path="userName" id="userName" class="myform-control" value="" readonly="true" /></td>
				</tr>

				<tr>
					<td><b><spring:message code="label.displayName" /></b></td>
					<td><form:input path="displayName" id="displayName"  class="myform-control" value="" readonly="true" /></td>
				</tr>


				<tr>
					<td><b><spring:message code="label.contactNumber" /></b></td>
					<td><form:input path="contactNo" value=""  class="myform-control" readonly="true" /></td>

				</tr>

				<tr>
					<td><b><spring:message code="label.altcontactNumber" /></b></td>
					<td><form:input path="altContactNo" value=""  class="myform-control" readonly="true" /></td>
			...
			<div class="space-10"></div>
				<table style="margin: 0px auto; position: relative;left: 2.15em;">
					<tr>
						<td><a href="apprMng" class="btn btn-success"><spring:message
