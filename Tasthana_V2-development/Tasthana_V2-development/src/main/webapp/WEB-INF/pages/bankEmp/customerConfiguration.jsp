...
<div class="right-container" id="right-container">
 ...
 --%>
				...
				<div class="set-rate-table">
					<div style="clear: both; margin-top: -15px;display:none">
						...
						<div class="form-group" style="clear: both;"
							style="display:none;" id="accountTypeDIV">
								...
								<c:when test="${setCategory!=null}">
									<div class="col-md-4">
										...
										<form:select id="setCategory" path="type"
											class="myform-control" onchange="selectCategory(this.value);">
											<option value="">
												<spring:message code="label.select" />
											</option>
						...
						<div class="form-group" id='tdsDiv'>
							...
							<div class="col-md-4">
								<form:input path="tds" id="tds" onkeypress="return isNumberKey1(event,$(this))" class="myform-control"
									type="text" min="0" max="99" readonly="true"></form:input>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<form:input path="fdFixedPercent" id="deposit" onkeypress="return isNumberKey1(event,$(this))"
									...
									onchange="onChangeFixPercent('deposit','fdVariablePercent')"  readonly="true"></form:input>
							</div>
						...
						<div class="form-group" id="minIntAmtForTDSDeductionDiv">
							...
							<div class="col-md-4">
								<form:input id="minIntAmtForTDSDeduction" onkeypress="return isNumberKey1(event,$(this))" 
									...
									type="text" step=".01"  readonly="true"></form:input>
							</div>
						</div>
...
<%-- 										<td><c:out value="${rate.id}"></c:out></td> --%>
										...
										<%-- <td><a
											href="editCustomerConfiguration?nriAccountType=${rate.nriAccountType}&citizen=${rate.citizen}&type=${rate.type}"
	   ...
	   if (charCode != 46 && charCode > 31 
		...
		function validation() {
			...
			$("#bankConfigurationForm").attr("action",
					"customerConfiguration?RIRadio=RI");
