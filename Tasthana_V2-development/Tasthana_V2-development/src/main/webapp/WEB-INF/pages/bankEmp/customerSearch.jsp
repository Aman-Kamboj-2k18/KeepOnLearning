...
<div class="right-container" id="right-container">
	<div class="container-fluid">
								...
								<c:forEach items="${endUserList}" var="user">
									...
									<tr>
										...
										<td><b><form:radiobutton path="id" name="cusId"
													value="${user.id}" onclick="onclickRadio('${user.id}','${user.customerName}')" /></b></td>
		...
		function submitForm() {
			...
			$("#fdForm").attr("action", "reverseEmiOnBasis?customerId="+customerId+"&userName="+customerName);
			$("#fdForm").submit();
		...
		<script>
			...
			function onclickRadio(customerId,customerName) {
