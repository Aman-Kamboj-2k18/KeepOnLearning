			...
			<div class="flexi_table" style="margin-top: 7px;">
					...
					<div class="col-md-6">
						...
						<div class="form-group" id="ripDiv">
							<label class="col-md-4 control-label" style="padding-top: 14px; margin-left: 0;"><spring:message
					...
					<div class="col-md-6">
						<div class="form-group" id="accountTypeDIV">
							<label class="col-md-4 control-label" style="padding-top: 14px; margin-left: 70px;"><spring:message
									code="label.accountType" /><span style="color: red">*</span></label>


							<div class="col-md-4" style="margin-left: -15px; min-width: 165px;">
								<form:select id="nriAccountType" path="nriAccountType"
									class="myform-control" onchange="nriAccount(this.value)">
									<form:option value="">
							...
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${setCategory!=null}">
										<div class="col-md-6" style="min-width: 125px !important; margin-left: -20px;">

											<form:select id="setCategory" path="category"
												class="myform-control" required="true" onchange="getDepositClassification()">
					...
					<div style="clear: both; margin-left: 55px; margin-top:35px margin-bottom: -5px;" class="col-md-12">
					<h4>
					<spring:message code="label.amountSlab" />

				    </h4></div>
				    <div style="clear: both; width: 455px; border-top: 1px dotted #cfcfcf; margin-left:85px;"></div>
				    <div style="clear: both" class="col-md-12">
					<div class="form-group" style="margin-left: 3px;">
						<div class="form-group col-md-4">
						<label class="col-md-6 control-label" style="padding-top: 16px;"><spring:message
								code="label.from" /><span style="color: red">*</span></label>
						<div class="col-md-6" style="min-width: 150px !important; margin-left: -15px;">													
							<form:input path="amountSlabFrom" id="amountSlabFrom"
								class="myform-control"
								required="true" /><span class="errmsg" id="errmsgSF"></span>
					    ...
					    <div class="form-group col-md-4">
						<label class="col-md-6 control-label" style="padding-top: 16px; margin-left:-140px;"><spring:message
								code="label.to" /></label>
						<div class="col-md-6" style="min-width: 150px !important; margin-left: -15px;">
							<form:input path="amountSlabTo" id="amountSlabTo"
								class="myform-control"
								required="true" /><span class="errmsg" id="errmsgST"></span>
					...
					<div class="form-group col-md-4">
						...
						<div class="col-md-7" style="margin-top: -14px; margin-left: -15px; min-width: 145px;">
					...
					<div style="text-align: center !important; margin-left: 225px;">
						<table class="table data jqtable example" id="my-table"
							...
							<c:if test="${! empty ratesPeriod}">
								...
								<c:forEach items="${ratesPeriod}" var="ratePeriod"
									varStatus="dl">
									<tr>
										...
										<td style="width: 30%;"><form:input path="rateList"
												...
												onkeyup="enterRate('${ratePeriod.id}','${dl.index}')"    onkeypress="rateListValidation('${ratePeriod.id}',event)"/></td>
				...
				<div class="form-group">
					...
					<div class="col-md-8" style="padding-left: 25px;">
						...
						<input type="button" id="goBtn" class="btn btn-info"
							data-toggle="tooltip" onclick="submitData()" value="Proceed"> <span
							id="blankFormError" style="color: red;"> </span>
							<span
							id="radioError" style="color: red;"> </span> <span
							id="succMsg" style="color: blue;"> </span>
							<span
							id="nriAccountTypeError" style="color: red;"> </span>
							<span
							id="depositClassificationError" style="color: red;"> </span>
							<span
							id="addRateCategoryError" style="color: red;"> </span>
					</div>
...
.ready(
		function() {
			...
			if(NRIRadioChecked == true || RIRadioChecked == true){
				document.getElementById("setCategory").value = '${category}';
			}
...
function populateRate(){
	...
	$.ajax({  
		async: false,
		type: "GET",  
	    url: "<%=request.getContextPath()%>/bnkEmp/getRateDurationsByDepositClaasification", 
...
function submitData(){
	 ...
	 var taskArray = new Array();
		...
		$.ajax({
			  url: "<%=request.getContextPath()%>/bnkEmp/addRatePost",
...
<script type="text/javascript">
	...
	function getDepositClassification(){
		...
		$("#addRateForm").attr("action", "getRateDurationsByDepositClaasification?depositClassification="+depositClassification+"&category="+category+"&nriAccType="+nriAccType);
		$("#addRateForm").submit();
