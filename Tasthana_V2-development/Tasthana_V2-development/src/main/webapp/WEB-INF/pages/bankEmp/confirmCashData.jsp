...
<div class="Flexi_deposit">
	...
	<div class="header_customer">
		<h3 align="center">
			<spring:message code="label.confirmCashDeposit" />
		</h3>
	</div>
<div class="Success_msg">
	...
	<form:form action="saveCashData" method="post" name="fixedDeposit" commandName="cashPaymentForm"
		onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			<table align="center" class="f_deposit_btn">
				<tr>
					...
					<td> <a href="payment" class="btn btn-success"><spring:message code="label.back"/></a> 
