...
<div class="right-container" id="right-container">
	<div class="container-fluid">
			...
			<div class="flexi_table">
				<form:form class="form-horizontal"  id="jounalForm" method="POST"
                   ...
                   <form:hidden path="fdAccountNo"/>
					...
					<div class="form-group">
						<label class="col-md-8 control-label" style="margin-top: -4px;">Ledger Common Account</label>
						<div class="col-md-4">
							<input type="checkbox"  id="ledgerCommonAccount" name="type" value="ledgerCommonAccount"> 
					...
					<div class="form-group" style="margin-left: 50px;">
						<div class="col-md-8"> <a href="searchAllLedgerByDate" class="btn btn-info"><spring:message
									code="label.back" /></a>
		...
		function ledgerList(){
			...
			$("#jounalForm").attr("action", "ledgerAllList?myArray="+myArray);
			$("#jounalForm").submit();
