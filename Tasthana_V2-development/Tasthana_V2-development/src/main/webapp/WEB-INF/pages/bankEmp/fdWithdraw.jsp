...
$(document).ready(function() {
	...
	else if('${withdrawForm.modeOfPayment}'=='Fund Transfer'){
	...
	function getAmountToLose(){
		...
		var withdrawAmt= document.getElementById('withdrawAmount').value;
		  ...
		  $.ajax({  
			 async: false,
		    type: "GET",  
		    url: "<%=request.getContextPath()%>/bnkEmp/getLooseAmountForWithdraw", 
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<table align="center" class="f_deposit_btn">
							<tr>
								...
								<td><a href="withDrawFDSearch" class="btn btn-danger"><spring:message
