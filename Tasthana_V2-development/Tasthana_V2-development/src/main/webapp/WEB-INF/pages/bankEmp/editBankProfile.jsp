...
<div class="header_customer" style="margin-bottom:30px;">
				...
				<div class="p_content">
					<form:form action="confirmEditBankProfile" name="editProfile" class="form-horizontal" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
					<div class="col-md-3">
					...
					<div class="col-md-9">
						...
						<form:hidden path="transactionId"/>
							...
							<div class="form-group">
										...
										<div class="col-md-6">
											<form:input path="altContactNo" class="myform-control" id="altContactNo" placeholder="Enter Alternate Contact Number" autocomplete="off"></form:input>
							...
							<div class="form-group">
										<label class="col-md-4 control-label"><a href="editBankPWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePassword"/></a></label>
										<div class="col-md-6">
											<a href="dashboard" class="btn btn-success"><spring:message
								code="label.back" /></a> <input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
