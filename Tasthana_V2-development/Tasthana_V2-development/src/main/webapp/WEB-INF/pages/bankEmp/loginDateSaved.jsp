	...
	<div class="fdsaved-table">
		...
		<table align="center" >
           <!--  width="400" -->
			...
			<tr>
				<td><b style="font-size: 14px;"><spring:message code="label.status" />:</b></td>
					<td style="font-size: 14px; padding-left: 10px;"><b style="font-size: 14px;">${transactionStatus}</b></td>		
