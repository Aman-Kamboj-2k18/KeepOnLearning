...
function selectRoleInDropDown(value,id) {
	...
	function val() {
		...
		if (endDate == '') {
		 ...
		 var startDateFormatterManually = startDate.split("/");
		 var monthDayYearForStartDate = startDateFormatterManually[1]+"/"+ startDateFormatterManually[0]+"/" +startDateFormatterManually[2];
		 var endDateFormatterManually = endDate.split("/");
		 var monthDayYearForEndDate = endDateFormatterManually[1]+"/"+ endDateFormatterManually[0]+"/" +endDateFormatterManually[2]
		
		var startDateParse = new Date(monthDayYearForStartDate);
		var endDateParse = new Date(monthDayYearForEndDate);
		
		if (startDateParse > endDateParse) {
			document.getElementById('startDate').style.borderColor = "black";
			document.getElementById('endDate').style.borderColor = "red";
			$("#errorMsg").text("Expiry date should not be less than the start date. !");
...
<div class="right-container" id="right-container">
	<div class="container-fluid">
		...
		<div class="role-page"
			...
			<div class="exit">
				<h3 id ="errorMsg" class="errorMsg">${error}</h3>
			</div>

			<div class="list-of-rates-table" style="box-shadow: none !important;">
		
				<form:form action="confirmUser" id="createUserForm"
					...
					<div class="col-sm-12">
						...
						<div class="add-customer-table col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="control-label col-sm-4" for="displayName" style="padding-top: 16px; text-align: -webkit-left;"><spring:message
										code="label.name" /><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="displayName" class="myform-control"
										placeholder="Enter Name" id="displayName" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="bankId" style="padding-top: 16px; text-align: -webkit-left;"><spring:message
										code="label.bankId" /></b><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="bankId" class="myform-control"
										placeholder="Enter Bank Id" id="bankId" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="designation" style="padding-top: 16px; text-align: -webkit-left;"><spring:message
										code="label.designation" /></b><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="designation" class="myform-control"
										placeholder="Enter Designation" id="designation" pattern="[a-zA-Z ]+"/>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="currentRole" style="padding-top: 7px; text-align: -webkit-left;"><spring:message
										code="label.selectRole" /></b><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:select multiple="multiple"  path="currentRole" class="myform-control"
										id="currentRole">
										<form:option value="">
						...
						<span id="currentRoleError" style="display: none; color: red;">
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="contactNo" style="padding-top: 16px; text-align: -webkit-left;">Selected Role</label>
								<div class="col-sm-8">
									<div id="tagsId" class="myform-control" style="padding: 4px;border: 1px solid gray;margin: 4px 0;min-height:25px;">
							</div>
								</div>
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="contactNo" style="padding-top: 16px; text-align: -webkit-left;"><spring:message
										code="label.contactNumber" /></b><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="contactNo" class="myform-control"
						...
						<div class="add-customer-table col-sm-6 col-xs-12">
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="email" style="padding-top: 16px;"><spring:message
										code="label.email" /></b><span style="color: red">*</span></label>
								<div class="col-sm-8">
									<form:input path="email" class="myform-control"
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="altEmail" style="padding-top: 16px;"><spring:message
							...
							<div class="form-group">
								<label class="control-label col-sm-4" style="padding-top: 16px;"><spring:message
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="password" style="padding-top: 16px;"><spring:message
								...
								<input type="password" style="opacity: 0;position: absolute;width:0">
									...
									<form:input type="text" path="password"
										class="myform-control secure-font" placeholder="Enter Password"
										id="password" />
			...
			<div class="employee_details">
				...
				<div class="space-10"></div>
				<table class="table with-pager data jqtable example" id="my-table" style="width: 98%; margin-left: 12px;">
					<thead>
						<tr>
