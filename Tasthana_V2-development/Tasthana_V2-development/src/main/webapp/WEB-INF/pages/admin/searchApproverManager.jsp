			...
			<div class="header_customer" style="margin-bottom: 30px;">
				<h3>
					...
					<small><spring:message
							code="label.searchApproverManagerSuspend" /></small>
				</h3>
			</div>
...
<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-4 control-label"><spring:message
								code="label.appManagerName" /></label>
						<div class="col-md-6">
					...
					<div class="Success_msg">
						<div class="successMsg"
							style="text-align: center; color: red; font-size: 18px; margin-left: -157px;">
							...
							<table class="table table-striped table-bordered">
								...
								<c:forEach items="${endUserList}" var="user">
									...
									<tr>
										...
										<td><b><a href="suspendApproverManager?id=${user.id}">Select</a></b></td>
					...
					<div class="form-group">
						<div class="col-md-offset-4 col-md-8">
							<a href="approverManagerSuspend" class="btn btn-info"><spring:message
									code="label.back" /></a>
						</div>
					</div>
		...
		<script>
			function searchCustomer() {
				$("#fdForm").attr("action", "searchApproverManager");
				$("#fdForm").submit();
