...
<div class="right-container" id="right-container">
	<div class="container-fluid">
		...
		<div class="role-page" style="border: none;padding: 0;box-shadow: none;background: none;">
			...
			<form:form name="updateRole" action="updateRole" method="post"
				...
				<table class="col-sm-offset-2" style="position: relative; left: 4.5%; margin-bottom: 25px;">
					<tr>
