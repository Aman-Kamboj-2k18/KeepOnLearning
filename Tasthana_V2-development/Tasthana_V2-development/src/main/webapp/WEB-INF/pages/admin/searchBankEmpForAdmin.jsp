	...
	<div class="container-fluid">
		...
		<div class="Flexi_deposit">
			...
			<div class="header_customer" style="margin-bottom: 30px;">
				<h3>
					...
					<small>Search Bank Employee</small>
				</h3>
            ...
            <div class="successMsg"
				style="text-align: center; color: red; font-size: 18px; margin-left: -176px;">
							...
							<table class="table table-striped table-bordered">
								...
								<c:forEach items="${endUserList}" var="user">
									...
									<tr>
										...
										<td><b><a
												href="suspendBankEmpFromAdmin?id=${user.id}">Select</a></b></td>
		...
		<script>
			function searchCustomer() {
				$("#fdForm").attr("action", "searchBankEmpForAdmin");
				$("#fdForm").submit();
