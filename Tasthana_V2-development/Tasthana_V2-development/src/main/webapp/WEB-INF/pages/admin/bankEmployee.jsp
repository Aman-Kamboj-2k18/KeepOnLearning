...
<div class="right-container" id="right-container">
	<div class="container-fluid">
		...
		<div class="role-page" style="padding: 0; box-shadow: none; background: none;">

			<div class="header_customer col-sm-12">
				<h3>
			...
			<form:form name="role" action="insertDetails"
				...
				<div class="role-page-table col-sm-12">
					<table width="400">
						...
						<tr>
							...
							<td><form:input path="accExpiryDate"
									class="myform-control" readonly="true"
									value="${expiryDateFormat}" /> <%-- <form:input path="accExpiryDate" class="myform-control"
				...
				<div class="col-sm-offset-2">
					<table style="position: relative; right: 3%;">
						<tr>
							<td class="col-sm-8"><a href="createUser" class="btn btn-success"><spring:message
